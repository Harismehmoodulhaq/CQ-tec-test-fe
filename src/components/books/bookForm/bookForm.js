...
export const BookForm = () => {
  ...
  const { book } = useSelector(({ bookPage }) => bookPage);
            ...
            >
              <div>
                <TextField
                  ...
                  onChange={(evt) => {
                    setBook({ ...newBook, bookName: evt.target.value });
                  }}
                  disabled={!update}
                  variant="standard"
                />
                <TextField
                  ...
                  onChange={(evt) => {
                    setBook({ ...newBook, authorName: evt.target.value });
                  }}
                  disabled={!update}
                  variant="standard"
                />
                <TextField
                  ...
                  onChange={(evt) => {
                    setBook({ ...newBook, borrowedBy: evt.target.value });
                  }}
                  disabled={!update}
                  variant="standard"
                />
              ...
              <div>
                <LocalizationProvider dateAdapter={AdapterDateFns}>
                  <DateTimePicker
                    ...
                    disabled={!update}
                    onChange={(value) => {
                      setBook({ ...newBook, dateOfBorrow: value });
                    }}
                ...
                <LocalizationProvider dateAdapter={AdapterDateFns}>
                  <DateTimePicker
                    ...
                    disabled={!update}
                    onChange={(value) => {
                      setBook({ ...newBook, expectedDateOfReturn: value });
                    }}
                    renderInput={(params) => <TextField {...params} />}
                  />
                </LocalizationProvider>
